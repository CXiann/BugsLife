...
public class BugsLife {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /*
        printProjectDashboard(p);                                                   //print project dashboard
        printIssuesDashboard(p);                                                    //print issues dashboard using "Project" object(p)
        ...
        printIssuesSection(i1);                                                      //print issues page
        i1.updateStatus("Resolved");                                                 //update issues status @param : status to change into
        i1.updateComment(1, "Comment Updated 1st try");                              //update comment @param : commentId,textToUpdate
        i1.showHistory();                                                            //show activities history
        printIssuesSection(i1);                                                      //print issues page
